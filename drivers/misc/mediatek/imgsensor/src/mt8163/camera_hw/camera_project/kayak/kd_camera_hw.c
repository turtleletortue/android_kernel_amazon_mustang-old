...
#define PK_POWER_INFO(fmt, arg...) pr_err(fmt, ##arg)
...
#define VOL_1000 1000000
	...
	if (On) {
		...
		ISP_MCLK1_EN(1);
		PK_POWER_INFO("kayak camera sensor power on start\n");

		if (pinSetIdx == 0 && currSensorName && (strcmp(currSensorName,SENSOR_DRVNAME_GC2375MIPI_RAW_CHXT_REAR) == 0)) {

			PK_POWER_INFO("[PowerON]pinSetIdx:%d, currSensorName: %s\n",pinSetIdx, currSensorName);
		...
		} else if (pinSetIdx == 0 && currSensorName && (strcmp(currSensorName,SENSOR_DRVNAME_SP2509MIPI_RAW_BLX_REAR) == 0)) {
			...
			mdelay(10);
		} else if (pinSetIdx == 1 && currSensorName && (strcmp(currSensorName,SENSOR_DRVNAME_SP2509MIPI_RAW_CHXT_FRONT) == 0)) {
		...
		} else if (pinSetIdx == 0 && currSensorName && (strcmp(currSensorName,SENSOR_DRVNAME_GC2145_MIPI_YUV) == 0)) {
		...
		} else if (pinSetIdx == 1 && currSensorName &&(strcmp(currSensorName,SENSOR_DRVNAME_GC0310_MIPI_YUV) == 0)) {
		...
		if (pinSetIdx == 0 && currSensorName && (strcmp(currSensorName,SENSOR_DRVNAME_GC2375MIPI_RAW_CHXT_REAR) == 0)) {
			...
			PK_POWER_INFO("[PowerDown]pinSetIdx:%d, currSensorName:%s\n", pinSetIdx, currSensorName);
		...
		} else if (pinSetIdx == 1 && currSensorName && (strcmp(currSensorName, SENSOR_DRVNAME_GC2375MIPI_RAW_BLX_FRONT) == 0)) {
