...
void accdet_auxadc_switch(int enable)
{
	...
	if (enable) {
		...
		/* currently mic_voltage_delay is 80ms, this is too long for us. As we checked, 20ms shoudl be okay on abc123... anywya, we use half of the mic_voltage_delay here */
		if (needDelay)
 ...
 * However the HW connection on abc123 is reverted...
